...
const ServiceProviderLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    const getSelectedKey = () => {
        ...
        if (pathname.includes("/serviceProvider")) return "3";
        return "1";
    };
        ...
        <Layout style={{ minHeight: "100vh" }}>
            ...
            >
                ...
                <Menu
                    ...
                    onClick={(info) => {
                        if (info.key === "1") router.push("/municipality/dashboard");
                        if (info.key === "2") router.push("/municipality/incidents");
                        if (info.key === "3") router.push("/municipality/serviceProvider");
                    }}
                    items={[
                        {
                            key: "1",
