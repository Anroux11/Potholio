...
namespace Potholio.Migrations
{
    ...
    [Migration("20250717064551_Updated_Incidents")]
    partial class Updated_Incidents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Potholio.Domain.Addresses.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Potholio.Domain.Geolocations.Geolocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Potholio.Domain.Incidents.Incident", b =>
                {
                    b.HasOne("Potholio.Domain.Geolocations.Geolocation", "Geolocation")
                        .WithMany()
                    ...
                    b.HasOne("Potholio.Authorization.Users.User", "ReportingUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Potholio.Domain.ServiceProviders.ServiceProvider", b =>
                {
                    ...
                    b.HasOne("Potholio.Domain.Municipalities.Municipality", null)
