...
namespace Potholio.Migrations
{
    ...
    public partial class DB_Initilize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ServiceProviders_Municipalities_MunicipalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incidents_ServiceProviders_ServiceProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_ServiceProviderId",
                table: "Incidents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviders_MunicipalityId",
                table: "ServiceProviders",
                column: "MunicipalityId");
